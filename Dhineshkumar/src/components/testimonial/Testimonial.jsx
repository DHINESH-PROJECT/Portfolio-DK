...
const testimonialData = [
  {
    message:
      "Working with Dhinesh Kumar was a fantastic experience. Their attention to detail and commitment to quality exceeded our expectations.",
    ...
    name: "Ramesh Singh",
    designation: "Managing Director, Alpha Tech Company",
  },
  {
    message:
    ...
    name: "Ajith Kumar",
    designation: "Team Lead, Vcodez Company",
  },
  {
    message:
    ...
    name: "Tamil Selvan",
    designation: "Senior manager, It vedant",
  },
];
