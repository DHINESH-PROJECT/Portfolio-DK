...
const rolesData = [
  {
    ...
    description:
      "I design intuitive and enjoyable experiences by understanding user needs, conducting research, and creating websites,and portfolios that enhance usability.",
  },
  {
    id: 2,
      ...
      <div className="flex flex-col justify-between h-fit md:pe-8 lg:pe-35.75 max-md:text-center my-auto">
        ...
        <div className="mt-6 text-[14px]">
          <p className="text-xs sm:text-lg font-normal text-gray-400 mb-4">
            I specialize in Full Stack Development, creating engaging
